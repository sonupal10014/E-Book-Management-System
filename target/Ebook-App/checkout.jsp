...
<script>
    ...
    function payNow() {
        var amount = <%= (int)(totalPrice * 100) %>; // Razorpay amount in paisa
        var options = {
            ...
            "handler": function (response) {
                ...
                form.setAttribute("action", "online-patment-success.jsp");

                var paymentInput = document.createElement("input");
                paymentInput.setAttribute("type", "hidden");
                paymentInput.setAttribute("name", "payment_id");
                ...
                paymentMethodInput.setAttribute("value", "online");
            ...
            "prefill": {
                "name": "<%= ((User)session.getAttribute("userobj")).getName() %>",
                "email": "<%= ((User)session.getAttribute("userobj")).getEmail() %>"
            },
            "theme": {
                "color": "#3399cc"
            }
